        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#f3d6ff;">
              <i class="bi bi-person-badge" style="color:#5a3e6b;"></i>
            </div>
            <div>
              <small class="text-muted">Total Accounts</small>
              <div style="font-weight:700; font-size:20px">{{ $totalAccounts ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div style="font-weight:700; font-size:20px">{{ $activeAccounts ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#e0f2ff;">
              <i class="bi bi-shield-check" style="color:#1a73e8;"></i>
            </div>
            <div>
              <small class="text-muted">Admin Accounts</small>
              <div style="font-weight:700; font-size:20px">{{ $adminAccounts ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div style="font-weight:700; font-size:20px">{{ $suspendedAccounts ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <button class="btn btn-sm btn-outline-info" data-bs-toggle="tooltip" title="Reset Password">
                      <i class="bi bi-key"></i>
                    </button>
