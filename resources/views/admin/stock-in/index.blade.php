      ...
      <nav class="nav flex-column">
        ...
        <div class="collapse show" id="transactionsSubmenu">
          <div class="nav flex-column ms-3">
            {{-- Stock In --}}
            <a class="nav-link active" href="{{ route('admin.stock-in.index') }}">
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#f3d6ff;">
              <i class="bi bi-arrow-down-circle" style="color:#5a3e6b;"></i>
            </div>
            <div>
              <small class="text-muted">Total Stock Ins</small>
              <div style="font-weight:700; font-size:20px">{{ $totalStockIns ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#e9fbf1;">
              <i class="bi bi-box-seam" style="color:#23b07a;"></i>
            </div>
            <div>
              <small class="text-muted">Items Received</small>
              <div style="font-weight:700; font-size:20px">{{ $totalItemsReceived ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#fff2e0;">
              <i class="bi bi-truck" style="color:#f08a24;"></i>
            </div>
            <div>
              <small class="text-muted">Active Suppliers</small>
              <div style="font-weight:700; font-size:20px">{{ $activeSuppliers ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div style="font-weight:700; font-size:20px">{{ $recentStockIns ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
