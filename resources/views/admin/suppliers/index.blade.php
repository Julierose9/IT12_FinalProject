  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-nav">
      <nav class="nav flex-column">
        ...
        {{-- Suppliers --}}
        <a class="nav-link active" href="{{ route('admin.suppliers.index') }}">
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#f3d6ff;">
              <i class="bi bi-truck" style="color:#5a3e6b;"></i>
            </div>
            <div>
              <small class="text-muted">Total Suppliers</small>
              <div style="font-weight:700; font-size:20px">{{ $totalSuppliers ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background:#fff2e0;">
              <i class="bi bi-box-seam" style="color:#f08a24;"></i>
            </div>
            <div>
              <small class="text-muted">Products Supplied</small>
              <div style="font-weight:700; font-size:20px">{{ $totalProductsSupplied ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card p-3 stat-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div style="font-weight:700; font-size:20px">{{ $recentSuppliers ?? '0' }}</div>
            </div>
          </div>
        </div>
      </div>
