...
<head>
  ...
  <style>
    ...
    .sidebar { min-width:260px; max-width:260px; background:#fff; border-right:1px solid #eef2f7; height:100vh; position:fixed; top:0; left:0; padding:22px; display:flex; flex-direction:column; overflow:hidden; }
    ...
    .content-wrap { margin-left:280px; padding:28px; }
...
<main class="content-wrap">
  ...
  <div class="topbar">
    <div class="d-flex align-items-center gap-3">
      ...
      <small class="text-muted">Orders & Payments</small>
    </div>
          ...
          <div class="mb-3">
            ...
            <div id="products-container">
              <div class="product-row row g-2 mb-2">
                ...
                <div class="col-md-2">
                  <button type="button" class="btn btn-outline-danger btn-sm remove-product" disabled><i class="bi bi-trash"></i></button>
                </div>
              </div>
            </div>
