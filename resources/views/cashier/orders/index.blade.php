          ...
          <tbody>
            @foreach($orders as $order)
              <tr>
                ...
                <td><small class="text-muted">{{ $order->OrderDate->format('M d, Y h:i A') }}</small></td>
                <td>
                ...
                <td><div style="font-weight:600" class="text-success">₱{{ number_format($order->TotalAmount, 2) }}</div></td>
                <td>
