...
<head>
  ...
  <style>
    ...
    .sidebar { 
      min-width: 260px; /* Slightly expanded from 220px */
      max-width: 260px; /* Slightly expanded from 220px */
      background: #fff; 
    ...
    .content-wrap { margin-left:280px; padding:28px; } /* Adjusted for expanded sidebar */
